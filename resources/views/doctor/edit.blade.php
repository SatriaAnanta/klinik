...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('doctor.update') }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                            ...
                            <div class="card-body ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        <img class="card-img-top" src="{{ asset('doctor/' . $doctor->img) }}" style="margin-bottom:20px;">
                                            <input class="form-control{{ $errors->has('img') ? ' is-invalid' : '' }}" name="img" id="input-img" type="file" placeholder="{{ __('Image') }}" style="position: initial; opacity:1" value="{{ old('img', $doctor->img) }}"/>
                                            @if ($errors->has('img'))
